...
import numpy as np
 ...
 #Model does all the calculations to create the drawing.
 #This creates the shape of what is drawn.
class Model():
 ...
 #View creates the canvas area to draw the picture.
 #This sets up the window that will be presented when running - the view.
class View():
 ...
 #Side panel creates the side panel in the window.
 #This is where the two buttons are created.
class SidePanel():
 ...
 #Controller brings all the pieces together.
 #It's in charge of handling user input appropriately.
class Controller():
    def __init__(self):
        self.root = Tk.Tk()
        self.model = Model()
